...
const inputClass = 'h-12 border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#123524] outline-none transition placeholder:text-[#745546] focus:border-[#b36a45]'
const buttonClass = 'inline-flex h-12 items-center justify-center bg-[#0e3424] px-6 text-sm font-black uppercase tracking-[0.18em] text-[#f2dfd2] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
